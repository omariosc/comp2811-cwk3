...
LibraryPage::LibraryPage(std::vector<VideoFile *> &videos, Player *player)
    : QWidget() {
  // As player is no longer included on the page only a VideoLibrary is required
  // Still better to have it as a seperate page in case more additions are added in the future.
